...
//		System.out.println("------------------------------------------------------------");
    ...
    public static void main(String[] args) {
        System.out.println("Задание №5.1: ПРИБЛИЖЁННОЕ ВЫЧИСЛЕНИЕ ИНТЕГРАЛА ПРИ ПОМОЩИ КФ НАСТ");
        Integration_kf test = new Integration_kf();
